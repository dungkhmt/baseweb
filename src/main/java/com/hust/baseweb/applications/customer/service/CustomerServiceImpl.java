...
//        customerRepo.save(customer);
    ...
    @Override
    @Transactional
    public PartyCustomer save(CreateDistributorInputModel input) {
        ...
        PartyCustomer customer = new PartyCustomer();
        customer.setPartyId(partyId);
        customer.setCustomerCode(input.getDistributorCode());
        //customer.setParty(party);
        customer.setPartyType(partyType);
        customer.setCustomerName(input.getDistributorName());
        customer.setPostalAddress(new ArrayList<>());
