...
public interface HistoryLogQuizGroupQuestionParticipationExecutionChoiceRepo extends JpaRepository<HistoryLogQuizGroupQuestionParticipationExecutionChoice, UUID> {
