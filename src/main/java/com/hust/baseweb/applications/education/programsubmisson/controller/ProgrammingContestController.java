...
public class ProgrammingContestController {
    ...
    public ResponseEntity<?> distributeProblemsOfContestToParticipants(Principal principal, @RequestBody
    ...
    public ResponseEntity<?> getProblemsOfProgrammingContestAndUser(Principal principal, @PathVariable String contestId){
        UserLogin userLogin = userService.findById(principal.getName());
        List<ContestProblem> contestProblems = programmingContestUserRegistrationService.getProblemsOfContestAndUser(contestId,userLogin.getUserLoginId());
