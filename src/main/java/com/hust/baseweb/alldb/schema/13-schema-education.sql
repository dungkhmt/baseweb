...
(
    ...
    last_updated_stamp timestamp,
    created_stamp      timestamp,
    constraint pk_edu_course_teacher_preference primary key (course_id, teacher_id),
    constraint fk_edu_course_teacher_preference_course_id foreign key (course_id) references edu_course (course_id),
    constraint fk_edu_course_teacher_preference_teacher_id
) foreign key(teacher_id) references edu_teacher(teacher_id)
);
