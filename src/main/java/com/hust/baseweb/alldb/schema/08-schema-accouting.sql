...
create table payment(
    ...
    constraint fk_payment_from_party_id foreign key(from_party_id) references party(party_id),
    constraint fk_payment_to_party_id foreign key(to_party_id) references party(party_id),
