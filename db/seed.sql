...
INSERT INTO party (party_type_id, external_id, description, status_id, created_date, created_by_user_login, last_modified_date, last_modified_by_user_login, is_unread, last_updated_stamp, created_stamp, party_code) 
VALUES (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, FALSE, NOW(), NOW(), NULL);

INSERT  INTO person (party_id, first_name, middle_name, last_name, gender, birth_date, last_updated_stamp, created_stamp) 
VALUES ('287db6a8-2783-11ea-b1c9-54bf64436441','admin',',',',','M',NOW(),null,NOW());
...
VALUES ( 'admin', '$2a$10$3l5d7fPeBuwUSbXYBiSiOuohtbgyDu2J/C5TWGHmszoD4a6mKFmey', NULL, FALSE, TRUE, FALSE, FALSE, NULL, NULL, NOW(), NOW(), '287db6a8-2783-11ea-b1c9-54bf64436441');
